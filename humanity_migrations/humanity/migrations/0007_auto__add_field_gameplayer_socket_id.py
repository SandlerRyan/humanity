...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GamePlayer.socket_id'
        db.add_column('games_players', 'socket_id',
                      self.gf('django.db.models.fields.CharField')(default='randomsocket', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GamePlayer.socket_id'
        db.delete_column('games_players', 'socket_id')
