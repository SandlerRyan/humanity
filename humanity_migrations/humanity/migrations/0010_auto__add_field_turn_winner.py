...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Turn.winner'
        db.add_column('turns', 'winner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['humanity.Player']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Turn.winner'
        db.delete_column('turns', 'winner_id')
    ...
    models = {
        ...
        u'humanity.turn': {
            ...
            'winner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['humanity.Player']"})
        },
